...
const BASE_URL = 'https://papermc.io/api/v2/projects/waterfall/versions';
const path = '/workdir'
...
(async () => {
    let version = process.env.PAPER_VERSION || '1.18';
    ...
    await new Promise((resolve, reject) => {
        https.get(`${BASE_URL}/${version}/builds/${newestBuild}/downloads/waterfall-${version}-${newestBuild}.jar`, (res) => {
